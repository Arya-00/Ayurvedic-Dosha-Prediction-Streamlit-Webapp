...
def load_model():
    vat_model = tf.keras.models.load_model('vata_model.keras')
    pit_model = tf.keras.models.load_model('pitta_model.keras')
    kp_model = tf.keras.models.load_model('kapha_model.keras')
...
def show_predict_page():
    ...
    # css = '''<style>[data-testid="stSidebar"]{min-width: 400px;max-width: 800px;}</style>'''
    ...
    # st.markdown("#### Fill out your traits")
    with tab1:
